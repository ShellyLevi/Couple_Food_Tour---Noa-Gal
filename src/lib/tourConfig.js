...
export const tourConfig = {
  ...
  // הודעות דף הפתיחה
  welcomeTitle: "גל ונועה האהובים 🧡✨",
  welcomeSubtitle: "לא תמיד חייבת להיות סיבה למסיבה כדי לחגוג! 🎉",
  welcomeMessage: "למרות שנועה, זה שהתחלת עבודה חדשה... זו לגמרי סיבה מספיק טובה! 💼🥂✨",
